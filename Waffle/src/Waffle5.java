...
public class Waffle5 extends JFrame {
	...
	public Waffle5() {
		...
		JLabel lblSmall = new JLabel("Large");
		...
		lblSmall.setBounds(355, 24, 175, 117);
		...
		comboBox.setBounds(264, 288, 330, 30);
		...
		comboBox_1.setBounds(264, 351, 330, 30);
		...
		comboBox_2.setBounds(264, 412, 330, 30);
		...
		comboBox_2_1.setModel(new DefaultComboBoxModel(new String[] {"-", "Corn", "Crab strick", "Currant", "Foytong", "Pumpkin", "Coconut", "Taro", "Purple Sweet Potato", "Banana", "Chocolate chip", "Ham", "Cheddar Cheese", "Strawberryy Yam"}));
		comboBox_2_1.setToolTipText("");
		comboBox_2_1.setFont(new Font("Yu Mincho", Font.BOLD, 26));
		comboBox_2_1.setBounds(264, 479, 330, 30);
